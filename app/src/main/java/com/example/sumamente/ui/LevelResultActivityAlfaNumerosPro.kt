...
class LevelResultActivityAlfaNumerosPro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level_result_alfanumeros_pro)
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.levelScoresAlfaNumerosPro[currentLevel] = pointsEarned
        ScoreManager.currentScoreAlfaNumerosPro = max(ScoreManager.currentScoreAlfaNumerosPro + pointsEarned, 0)

        if (!ScoreManager.hasCompletedLevelAlfaNumerosPro(currentLevel)) {
        ...
        val velocidad = 1 / ScoreManager.getTiempoPromedioAlfaNumeros()
    ...
    private fun handleFailureScenario() {
        ...
        ScoreManager.lastIqComponentByGame["AlfaNumeros"] = 0
        ScoreManager.saveStatsGlobalAndAlfaNumeros()
    }
    ...
    private fun updateScoreToZero() {
        ...
        ScoreManager.levelScoresAlfaNumerosPro[currentLevel] = 0
        ScoreManager.saveScoreAlfaNumerosPro()
    }
        ...
        mainHandler.postDelayed({
            ...
            fadeOut.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                ...
                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                    ...
                    val fadeIn = AnimationUtils.loadAnimation(this@LevelResultActivityAlfaNumerosPro, R.anim.dialog_fade_in)
                    ...
                    val pointsAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityAlfaNumerosPro, R.anim.points_appear_from_back)
                    ...
                    pointsAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                        ...
                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                            ...
                            val checkAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityAlfaNumerosPro, R.anim.check_appear)
                            ...
                            checkAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                ...
                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                    ...
                                    val puntajeActualAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityAlfaNumerosPro, R.anim.points_appear_from_back)
                                    ...
                                    puntajeActualAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                        ...
                                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                            ...
                                            val timeAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityAlfaNumerosPro, R.anim.points_appear_from_back)
                                            ...
                                            timeAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                                ...
                                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                                    ...
                                                    val checkBlueAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityAlfaNumerosPro, R.anim.check_appear)
                                                    ...
                                                    mainHandler.postDelayed({
                                                        ...
                                                        rankingChangedTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityAlfaNumerosPro, R.anim.dialog_fade_in))
                                                    }, 300)

                                                    mainHandler.postDelayed({
                                                        unlockLevelTextView.visibility = View.VISIBLE
                                                        unlockLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityAlfaNumerosPro, R.anim.dialog_fade_in))
                                                    }, 600)

                                                    mainHandler.postDelayed({
                                                        repeatLevelTextView.visibility = View.VISIBLE
                                                        repeatLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityAlfaNumerosPro, R.anim.dialog_fade_in))
                                                    }, 900)
                                                }
    ...
    private fun showFailureDialog() {
        ...
        val isLevelBlockedAfterThisFail = ScoreManager.getConsecutiveFailuresAlfaNumerosPro(currentLevel) >= 12
    ...
    private fun navigateToInstructions() {
        val intent = Intent(this, InstructionsActivityAlfaNumerosPro::class.java)
        intent.putExtra("LEVEL", currentLevel)
        startActivity(intent)
        finish()
    }
