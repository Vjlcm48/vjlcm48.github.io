...
enum class ResponseModeRomasPro {
    SIMPLE_SELECTION_ROMAS,
    TYPE_ANSWER_ROMAS
}

class ResponseModeDialogRomasPro(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerRomasPro? = null
    ...
    private fun setupButtons() {
        ...
        btnSeleccionSimple?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeRomasPro.SIMPLE_SELECTION_ROMAS)
            }, 1000)
        }
        ...
        btnEscribeRespuesta?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeRomasPro.TYPE_ANSWER_ROMAS)
            }, 1000)
        }
    ...
    private fun sendResponseModeToCaller(mode: ResponseModeRomasPro) {
    ...
    fun setOnResponseModeSelectedListener(listener: OnResponseModeSelectedListenerRomasPro?) {
        this.listener = listener
    }

    interface OnResponseModeSelectedListenerRomasPro {
        fun onResponseModeSelected(mode: ResponseModeRomasPro)
    }
}