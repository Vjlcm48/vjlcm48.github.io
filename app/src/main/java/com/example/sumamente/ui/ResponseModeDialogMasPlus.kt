...
enum class ResponseModeMasPlus {
    SIMPLE_SELECTION,
    TYPE_ANSWER
}

class ResponseModeDialogMasPlus(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerMasPlus? = null
    ...
    private fun setupButtons() {
        ...
        btnSeleccionSimple?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeMasPlus.SIMPLE_SELECTION)
            }, 1000)
        }
        ...
        btnEscribeRespuesta?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeMasPlus.TYPE_ANSWER)
            }, 1000)
        }
    ...
    private fun sendResponseModeToCaller(mode: ResponseModeMasPlus) {
    ...
    fun setOnResponseModeSelectedListener(listener: OnResponseModeSelectedListenerMasPlus) {
        this.listener = listener
    }

    interface OnResponseModeSelectedListenerMasPlus {
        fun onResponseModeSelected(mode: ResponseModeMasPlus)
    }
}
