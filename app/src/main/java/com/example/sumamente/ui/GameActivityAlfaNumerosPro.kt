...
class GameActivityAlfaNumerosPro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scoreTextView.text = getString(R.string.score_label, ScoreManager.currentScoreAlfaNumerosPro)
    ...
    private fun calculateTimeSpent() {
        ...
        val textColor = when {
            timeSpentInSeconds < 2.0 -> ContextCompat.getColor(this, R.color.green_medium)
            timeSpentInSeconds < 3.5 -> ContextCompat.getColor(this, R.color.orange_dark)
