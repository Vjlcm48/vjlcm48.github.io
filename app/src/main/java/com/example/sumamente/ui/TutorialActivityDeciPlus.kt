...
class TutorialActivityDeciPlus : BaseActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tutorial_deci_plus)
        initViews()
        startSequence()
    ...
    private fun displayNextNumber() {
        ...
        tvNumber.apply {
            ...
            val bounce = AnimationUtils.loadAnimation(this@TutorialActivityDeciPlus, R.anim.bounce_in)
