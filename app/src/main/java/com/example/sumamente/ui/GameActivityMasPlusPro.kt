...
class GameActivityMasPlusPro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val responseMode = prefs.getString("selectedResponseModeMasPlusPro", intent.getStringExtra("RESPONSE_MODE_MASPLUS"))
