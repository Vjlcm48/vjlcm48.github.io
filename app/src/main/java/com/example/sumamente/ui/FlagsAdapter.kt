...
class FlagsAdapter(
    ...
    private val onFlagSelected: (String, View) -> Unit,
    context: Context
    ...
    override fun onBindViewHolder(holder: FlagViewHolder, position: Int) {
        val flagCode = flags[position]
        holder.bind(flagCode)
    ...
    fun updateFlags(newFlags: List<String>) {
        val diffCallback = FlagsDiffCallback(flags, newFlags)
    ...
    class FlagViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(flagCode: String) {
            ...
            if (flagResId != null) {
                ...
                val savedFlagResId = flagResourceMap[savedCountryCode]

                if (savedFlagResId != null) {
                    flagImageView.setImageResource(savedFlagResId)
                }
            }
        }
    }
