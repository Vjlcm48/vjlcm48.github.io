...
enum class ResponseModeDeciPlus {
    SIMPLE_SELECTION,
    TYPE_ANSWER
}

class ResponseModeDialogDeciPlus(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerDeciPlus? = null
    ...
    fun setOnResponseModeSelectedListener(listener: OnResponseModeSelectedListenerDeciPlus) {
        this.listener = listener
    }

    interface OnResponseModeSelectedListenerDeciPlus {
