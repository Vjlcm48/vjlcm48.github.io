...
class TutorialActivityGenioPlus : BaseActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tutorial_genio_plus)
        initViews()
        startSequence()
    ...
    private fun initViews() {
        ...
        checkEscribeRespuesta = findViewById(R.id.check_escribe_respuesta_tg)
    ...
    private fun displayNextNumber() {
        ...
        tvNumber.apply {
            ...
            val bounce = AnimationUtils.loadAnimation(this@TutorialActivityGenioPlus, R.anim.bounce_in)
                    ...
                    when {
                        seconds < 3.0 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@TutorialActivityGenioPlus, R.color.green_medium)
                            )
                        }
                        seconds < 4.36 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@TutorialActivityGenioPlus, R.color.orange_dark)
                            )
                        }
                        else -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@TutorialActivityGenioPlus, R.color.red)
                            )
                        }
                    }
