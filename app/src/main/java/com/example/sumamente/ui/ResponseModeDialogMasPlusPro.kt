...
enum class ResponseModeMasPlusPro {
    SIMPLE_SELECTION,
    TYPE_ANSWER
}

class ResponseModeDialogMasPlusPro(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerMasPlusPro? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSeleccionSimple?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeMasPlusPro.SIMPLE_SELECTION)
            }, 1000)
        }
        ...
        btnEscribeRespuesta?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeMasPlusPro.TYPE_ANSWER)
            }, 1000)
        }
    ...
    private fun sendResponseModeToCaller(mode: ResponseModeMasPlusPro) {
    ...
    fun setOnResponseModeSelectedListener(listener: OnResponseModeSelectedListenerMasPlusPro) {
        this.listener = listener
    }

    interface OnResponseModeSelectedListenerMasPlusPro {
        fun onResponseModeSelected(mode: ResponseModeMasPlusPro)
    }
}
