...
class ProfileEditDialog(context: Context) : Dialog(context) {
        ...
        val btnEditUsername = findViewById<androidx.appcompat.widget.AppCompatButton>(R.id.btn_edit_username)
        val btnEditFlag = findViewById<androidx.appcompat.widget.AppCompatButton>(R.id.btn_edit_flag)
