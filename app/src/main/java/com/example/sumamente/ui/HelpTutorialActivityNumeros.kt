...
class HelpTutorialActivityNumeros : BaseActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_help_tutorial_numeros)
        initViews()
        startSequence()
    ...
    private fun displayNextNumber() {
        ...
        tvNumber.apply {
            ...
            val bounce = AnimationUtils.loadAnimation(this@HelpTutorialActivityNumeros, R.anim.bounce_in)
                        ...
                        seconds < 3.0 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(
                                    this@HelpTutorialActivityNumeros,
    ...
    private fun restartTutorial() {
        stopBackgroundMusic()
        val intent = Intent(this, HelpTutorialActivityNumeros::class.java)
        startActivity(intent)
        finish()
    }
