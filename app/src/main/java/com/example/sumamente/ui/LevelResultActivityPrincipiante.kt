...
class LevelResultActivityPrincipiante : AppCompatActivity() {
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.levelScoresPrincipiante[currentLevel] = pointsEarned
        ScoreManager.currentScorePrincipiante = max(ScoreManager.currentScorePrincipiante + pointsEarned, 0)

        if (!ScoreManager.hasCompletedLevelPrincipiante(currentLevel)) {
            ScoreManager.addCompletedLevelPrincipiante(currentLevel)
        }

        // Conteo para pines //
        CondecoracionTracker.marcarNivelConTimestamp("NumerosPlus", "Principiante", currentLevel)
        CondecoracionTracker.verificarYEntregarPines()

        if (currentLevel >= ScoreManager.unlockedLevelsPrincipiante) {
            ScoreManager.unlockedLevelsPrincipiante = currentLevel + 1
        }
    ...
    private fun verificarTrofeosParaDobleCondecoracion(nuevaMedalla: CondecoracionTracker.MedallaObtenida) {
        ...
        CondecoracionTracker.verificarYEntregarTrofeos("NumerosPlus", "Principiante") { nuevoTrofeo ->
            if (nuevoTrofeo != null) {
    ...
    private fun updateScoreToZero() {
        ...
        ScoreManager.levelScoresPrincipiante[currentLevel] = 0
        ScoreManager.saveScorePrincipiante()
    }
        ...
        mainHandler.postDelayed({
            ...
            fadeOut.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                ...
                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                    ...
                    val fadeIn = AnimationUtils.loadAnimation(this@LevelResultActivityPrincipiante, R.anim.dialog_fade_in)
                    ...
                    val pointsAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityPrincipiante, R.anim.points_appear_from_back)
                    ...
                    pointsAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                        ...
                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                            ...
                            val checkAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityPrincipiante, R.anim.check_appear)
                            ...
                            checkAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                ...
                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                    ...
                                    val puntajeActualText = getString(R.string.puntaje_actual, puntosPrincipiante)
                                    val spannablePuntajeActual = SpannableString(puntajeActualText)
                                    val puntosStrActual = puntosPrincipiante.toString()
                                    ...
                                    val puntajeActualAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityPrincipiante, R.anim.points_appear_from_back)
                                    ...
                                    puntajeActualAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                        ...
                                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                            ...
                                            val timeAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityPrincipiante, R.anim.points_appear_from_back)
                                            ...
                                            timeAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                                ...
                                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                                    ...
                                                    val checkBlueAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityPrincipiante, R.anim.check_appear)
                                                    ...
                                                    mainHandler.postDelayed({
                                                        ...
                                                        rankingChangedTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityPrincipiante, R.anim.dialog_fade_in))
                                                    }, 300)

                                                    mainHandler.postDelayed({
                                                        unlockLevelTextView.visibility = View.VISIBLE
                                                        unlockLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityPrincipiante, R.anim.dialog_fade_in))
                                                    }, 600)

                                                    mainHandler.postDelayed({
                                                        repeatLevelTextView.visibility = View.VISIBLE
                                                        repeatLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityPrincipiante, R.anim.dialog_fade_in))
                                                    }, 900)
                                                }
    ...
    private fun showFailureDialog() {
        ...
        val isLevelBlockedAfterThisFail = ScoreManager.getConsecutiveFailuresPrincipiante(currentLevel) >= 12
    ...
    private fun navigateToInstructions() {
        val intent = Intent(this, InstructionsActivityPrincipiante::class.java)
        intent.putExtra("LEVEL", currentLevel)
        startActivity(intent)
        finish()
    }
    ...
    private fun navigateToLevels() {
        val intent = Intent(this, LevelsActivityPrincipiante::class.java)
        startActivity(intent)
        finish()
    }
