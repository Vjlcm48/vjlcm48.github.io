    ...
    private fun createLevelButtons() {
        ...
        for (i in levelStrings.indices) {
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    0,
                    48.dpToPx(this@LevelsActivityPrincipiante),
                    1f
                ).apply {
                ...
                setPadding(
                    ...
                    8.dpToPx(this@LevelsActivityPrincipiante),
                    16.dpToPx(this@LevelsActivityPrincipiante),
                    8.dpToPx(this@LevelsActivityPrincipiante)
                )
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    36.dpToPx(this@LevelsActivityPrincipiante),
                    36.dpToPx(this@LevelsActivityPrincipiante)
                ).apply {
                    gravity = Gravity.CENTER_VERTICAL
                }
                setImageResource(if (i < ScoreManager.unlockedLevelsPrincipiante && !ScoreManager.isLevelBlockedByFailuresPrincipiante(i + 1))
