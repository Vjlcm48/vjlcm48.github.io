...
class GameActivityRomasPro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val responseMode = intent.getStringExtra("RESPONSE_MODE_ROMAS") ?: prefs.getString("selectedResponseModeRomasPro", null)
    ...
    private fun generateNumbers() {
        ...
        when (level) {
            in 1..7 -> {
                ...
                largeNumbers.addAll(generateRandomNumbers(5, 7..15))
            }
            in 8..14 -> {
            ...
            in 15..21 -> {
                ...
                largeNumbers.addAll(generateRandomNumbers(6, 7..15))
            }
            in 22..28 -> {
    ...
    private fun startChronometer() {
        ...
        chronometerTimer = object : CountDownTimer(6000, 75) {
            override fun onTick(millisUntilFinished: Long) {
                ...
                val textColor = when {
                    ...
                    elapsedSeconds < 4.5 -> ContextCompat.getColor(this@GameActivityRomasPro, R.color.orange_dark)
                    else -> ContextCompat.getColor(this@GameActivityRomasPro, R.color.red)
                }
                ...
                if (elapsedSeconds >= 4.5 && !soundPlayed) {
                    soundPlayed = true
                    playAlertSound()
                }
            }
            ...
            override fun onFinish() {
                ...
                spannableString.setSpan(
                    ForegroundColorSpan(ContextCompat.getColor(this@GameActivityRomasPro, R.color.red)),
                    0,
                    finalTime.length,
                    Spannable.SPAN_EXCLUSIVE_EXCLUSIVE
                )
    ...
    private fun calculateTimeSpent() {
        ...
        val textColor = when {
            timeSpentInSeconds < 2.5 -> ContextCompat.getColor(this, R.color.green_medium)
            timeSpentInSeconds < 4.5 -> ContextCompat.getColor(this, R.color.orange_dark)
