...
class LevelsActivityMasPlus : AppCompatActivity() {
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityMasPlus)
                }
            ...
            val lockIcon = ImageView(this).apply {
                ...
                setImageResource(if (i < ScoreManager.unlockedLevelsMasPlus) R.drawable.ic_unlock else R.drawable.ic_lock)
            ...
            Log.d("LevelsActivityMasPlus", "Added button for level ${i + 1}")
        }
    }
    ...
    private fun showInstructions(level: Int, mode: ResponseModeMasPlus? = null) {
