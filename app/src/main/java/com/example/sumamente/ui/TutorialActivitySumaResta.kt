...
class TutorialActivitySumaResta : BaseActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tutorial_suma_resta)
        initViews()
        startSequence()
    ...
    private fun initViews() {
        ...
        checkSeleccionSimple = findViewById(R.id.check_seleccion_simple_tsr)
    ...
    private fun displayNextNumber() {
        ...
        tvNumber.apply {
            ...
            val bounce = AnimationUtils.loadAnimation(this@TutorialActivitySumaResta, R.anim.bounce_in)
                        ...
                        seconds < 3.0 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(
                                    this@TutorialActivitySumaResta,
