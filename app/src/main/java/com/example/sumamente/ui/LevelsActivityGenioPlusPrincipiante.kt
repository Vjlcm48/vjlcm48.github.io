    ...
    private fun createLevelButtons() {
        ...
        for (i in levelStrings.indices) {
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    0,
                    48.dpToPx(this@LevelsActivityGenioPlusPrincipiante),
                    1f
                ).apply {
                ...
                setPadding(
                    ...
                    8.dpToPx(this@LevelsActivityGenioPlusPrincipiante),
                    16.dpToPx(this@LevelsActivityGenioPlusPrincipiante),
                    8.dpToPx(this@LevelsActivityGenioPlusPrincipiante)
                )
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    36.dpToPx(this@LevelsActivityGenioPlusPrincipiante),
                    36.dpToPx(this@LevelsActivityGenioPlusPrincipiante)
                ).apply {
                    gravity = Gravity.CENTER_VERTICAL
                }
                setImageResource(if (i < ScoreManager.unlockedLevelsGenioPlusPrincipiante) R.drawable.ic_unlock else R.drawable.ic_lock)
