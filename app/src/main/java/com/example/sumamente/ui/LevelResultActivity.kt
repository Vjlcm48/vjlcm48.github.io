...
class LevelResultActivity : AppCompatActivity() {
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.levelScores[currentLevel]?.let { previousScore ->
            ScoreManager.currentScore -= previousScore
        }

        ScoreManager.levelScores[currentLevel] = pointsEarned
        ScoreManager.currentScore = max(ScoreManager.currentScore + pointsEarned, 0)
        ...
        val aporte = (factor * velocidad * precision * 5).toInt()
    ...
    private fun updateScoreToZero() {
        ...
        ScoreManager.levelScores[currentLevel] = 0
        ScoreManager.saveScore()
    }
                        ...
                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                            ...
                            checkAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                ...
                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                    ...
                                    val puntosStrActual = puntosNumerosPlus.toString()
                                    ...
                                    val puntajeActualAnimation = AnimationUtils.loadAnimation(this@LevelResultActivity, R.anim.points_appear_from_back)
                                            ...
                                            timeAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                                ...
                                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                                    ...
                                                    mainHandler.postDelayed({
                                                        ...
                                                        rankingChangedTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivity, R.anim.dialog_fade_in))
                                                    }, 300)

                                                    mainHandler.postDelayed({
                                                        unlockLevelTextView.visibility = View.VISIBLE
                                                        unlockLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivity, R.anim.dialog_fade_in))
                                                    }, 600)

                                                    mainHandler.postDelayed({
                                                        repeatLevelTextView.visibility = View.VISIBLE
                                                        repeatLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivity, R.anim.dialog_fade_in))
                                                    }, 900)
                                                }
    ...
    private fun showFailureDialog() {
        ...
        val isLevelBlockedAfterThisFail = ScoreManager.getConsecutiveFailures(currentLevel) >= 12
