...
class TutorialActivityAlfaNumeros : BaseActivity()  {
    ...
    // Botones de respuesta demo eliminados: solo entrada manual en este tutorial
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tutorial_alfa_numeros)
        initViews()
        startSequence()
    ...
    private fun displayNextNumber() {
        ...
        tvNumber.apply {
            ...
            val bounce = AnimationUtils.loadAnimation(this@TutorialActivityAlfaNumeros, R.anim.bounce_in)
                    ...
                    when {
                        seconds < 3.0 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@TutorialActivityAlfaNumeros, R.color.green_medium)
                            )
                        }
                        seconds < 4.36 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@TutorialActivityAlfaNumeros, R.color.orange_dark)
                            )
                        }
                        else -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@TutorialActivityAlfaNumeros, R.color.red)
                            )
                        }
                    }
