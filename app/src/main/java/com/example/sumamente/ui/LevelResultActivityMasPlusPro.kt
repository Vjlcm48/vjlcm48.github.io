...
class LevelResultActivityMasPlusPro : AppCompatActivity() {
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.totalGamesMasPlusPro += 1
        ...
        ScoreManager.levelScoresMasPlusPro[currentLevel]?.let { previousScore ->
            ScoreManager.currentScoreMasPlusPro -= previousScore
        }

        ScoreManager.levelScoresMasPlusPro[currentLevel] = pointsEarned
        ScoreManager.currentScoreMasPlusPro = max(ScoreManager.currentScoreMasPlusPro + pointsEarned, 0)

        if (!ScoreManager.hasCompletedLevelMasPlusPro(currentLevel)) {
    ...
    private fun handleFailureScenario() {
        ...
        ScoreManager.lastIqComponentByGame["MasPlus"] = 0
        ScoreManager.saveStatsGlobalAndMasPlus()
    }
    ...
    private fun calculatePoints(): Int {
        ...
        var tiempoPromedio = if (ScoreManager.totalGamesMasPlus > 0) {
            (ScoreManager.totalTimeMasPlus + timeSpentInSeconds) / (ScoreManager.totalGamesMasPlus + 1)
        } else {
            timeSpentInSeconds
        }
    ...
    private fun updateScoreToZero() {
        ...
        ScoreManager.levelScoresMasPlusPro[currentLevel] = 0
        ScoreManager.saveScoreMasPlusPro()
    }
        ...
        mainHandler.postDelayed({
            ...
            fadeOut.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                ...
                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                    ...
                    val fadeIn = AnimationUtils.loadAnimation(this@LevelResultActivityMasPlusPro, R.anim.dialog_fade_in)
                    ...
                    val pointsAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityMasPlusPro, R.anim.points_appear_from_back)
                    ...
                    pointsAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                        ...
                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                            ...
                            val checkAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityMasPlusPro, R.anim.check_appear)
                            ...
                            checkAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                ...
                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                    ...
                                    val puntosMasPlusActual = ScoreManager.currentScoreMasPlusPro
                                    ...
                                    val puntajeActualAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityMasPlusPro, R.anim.points_appear_from_back)
                                    ...
                                    puntajeActualAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                        ...
                                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                            ...
                                            val timeAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityMasPlusPro, R.anim.points_appear_from_back)
                                            ...
                                            timeAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                                ...
                                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                                    ...
                                                    val checkBlueAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityMasPlusPro, R.anim.check_appear)
                                                    ...
                                                    mainHandler.postDelayed({
                                                        ...
                                                        rankingChangedTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityMasPlusPro, R.anim.dialog_fade_in))
                                                    }, 300)

                                                    mainHandler.postDelayed({
                                                        unlockLevelTextView.visibility = View.VISIBLE
                                                        unlockLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityMasPlusPro, R.anim.dialog_fade_in))
                                                    }, 600)

                                                    mainHandler.postDelayed({
                                                        repeatLevelTextView.visibility = View.VISIBLE
                                                        repeatLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityMasPlusPro, R.anim.dialog_fade_in))
                                                    }, 900)
                                                }
    ...
    private fun showFailureDialog() {
        ...
        val isLevelBlockedAfterThisFail = ScoreManager.getConsecutiveFailuresMasPlusPro(currentLevel) >= 12
    ...
    private fun navigateToInstructions() {
        val intent = Intent(this, InstructionsActivityMasPlusPro::class.java)
