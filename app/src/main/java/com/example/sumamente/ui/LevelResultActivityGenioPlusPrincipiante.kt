...
class LevelResultActivityGenioPlusPrincipiante : AppCompatActivity() {
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.levelScoresGenioPlusPrincipiante[currentLevel]?.let { previousScore ->
            ScoreManager.currentScoreGenioPlusPrincipiante -= previousScore
        }
    ...
    private fun verificarTrofeosParaDobleCondecoracion(nuevaMedalla: CondecoracionTracker.MedallaObtenida) {
        CondecoracionTracker.verificarYEntregarTrofeos("GenioPlus", "Principiante") { nuevoTrofeo ->
            if (nuevoTrofeo != null) {
    ...
    private fun updateScoreToZero() {
        ...
        ScoreManager.levelScoresGenioPlusPrincipiante[currentLevel] = 0
        ScoreManager.saveScoreGenioPlusPrincipiante()
    }
        ...
        mainHandler.postDelayed({
            ...
            fadeOut.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                ...
                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                    ...
                    val fadeIn = AnimationUtils.loadAnimation(this@LevelResultActivityGenioPlusPrincipiante, R.anim.dialog_fade_in)
                    ...
                    pointsAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                        ...
                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                            ...
                            val checkAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityGenioPlusPrincipiante, R.anim.check_appear)
                            ...
                            checkAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                ...
                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                    val puntosGenios = ScoreManager.currentScoreGenioPlusPrincipiante
                                    ...
                                    val puntajeActualAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityGenioPlusPrincipiante, R.anim.points_appear_from_back)
                                        ...
                                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                            ...
                                            timeAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                                ...
                                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                                    ...
                                                    val checkBlueAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityGenioPlusPrincipiante, R.anim.check_appear)
                                                    ...
                                                    mainHandler.postDelayed({
                                                        ...
                                                        rankingChangedTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityGenioPlusPrincipiante, R.anim.dialog_fade_in))
                                                    }, 300)

                                                    mainHandler.postDelayed({
                                                        unlockLevelTextView.visibility = View.VISIBLE
                                                        unlockLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityGenioPlusPrincipiante, R.anim.dialog_fade_in))
                                                    }, 600)

                                                    mainHandler.postDelayed({
                                                        repeatLevelTextView.visibility = View.VISIBLE
                                                        repeatLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityGenioPlusPrincipiante, R.anim.dialog_fade_in))
                                                    }, 900)
                                                }
    ...
    private fun showFailureDialog() {
        ...
        val isLevelBlockedAfterThisFail = ScoreManager.getConsecutiveFailuresGenioPlusPrincipiante(currentLevel) >= 12
    ...
    private fun navigateToInstructions() {
        val intent = Intent(this, InstructionsActivityGenioPlusPrincipiante::class.java)
