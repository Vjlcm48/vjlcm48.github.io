...
class ResponseModeDialogSumaResta(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerSumaResta? = null
    ...
    fun setOnResponseModeSelectedListener(listener: OnResponseModeSelectedListenerSumaResta) {
        this.listener = listener
    }

    interface OnResponseModeSelectedListenerSumaResta {
