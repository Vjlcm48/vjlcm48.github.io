...
class ResponseModeDialogSumaRestaPro(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerSumaRestaPro? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.response_mode_dialog_suma_resta_pro)
    ...
    fun setOnResponseModeSelectedListener(listener: OnResponseModeSelectedListenerSumaRestaPro) {
        this.listener = listener
    }

    interface OnResponseModeSelectedListenerSumaRestaPro {
