...
class ResponseModeDialogSumaRestaPrincipiante(context: Context) : AppCompatDialog(context) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.response_mode_dialog_suma_resta_principiante)
        ...
        btnSeleccionSimple?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeSumaResta.SIMPLE_SELECTION)
            }, 1000)
        }
        ...
        btnEscribeRespuesta?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeSumaResta.TYPE_ANSWER)
            }, 1000)
        }
    ...
    private fun sendResponseModeToCaller(mode: ResponseModeSumaResta) {
    ...
    interface OnResponseModeSelectedListenerSumaRestaPrincipiante {
        fun onResponseModeSelected(mode: ResponseModeSumaResta)
    }
}
