...
class LevelResultActivityGenioPlusPro : AppCompatActivity() {
    ...
    private fun handleSuccessScenario() {
        ...
        if (currentLevel >= ScoreManager.unlockedLevelsGenioPlusPro) {
            ScoreManager.unlockedLevelsGenioPlusPro = currentLevel + 1
        }
        ...
        val aporte = (factor * velocidad * precision * 18).toInt()
