...
class LevelResultActivitySumaRestaPro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_level_result_suma_resta_pro)
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.totalGamesSumaRestaPro += 1
        ...
        ScoreManager.levelScoresSumaRestaPro[currentLevel]?.let { previousScore ->
            ScoreManager.currentScoreSumaRestaPro -= previousScore
        }

        ScoreManager.levelScoresSumaRestaPro[currentLevel] = pointsEarned
        ScoreManager.currentScoreSumaRestaPro = max(ScoreManager.currentScoreSumaRestaPro + pointsEarned, 0)

        if (!ScoreManager.hasCompletedLevelSumaRestaPro(currentLevel)) {
            ScoreManager.addCompletedLevelSumaRestaPro(currentLevel)
        }
...
// Conteo para pines //
        ...
        val aporte = ((factor * velocidad * precision * 14) * 100).roundToInt() / 100.0
    ...
    private fun verificarTrofeosParaDobleCondecoracion(nuevaMedalla: CondecoracionTracker.MedallaObtenida) {
        CondecoracionTracker.verificarYEntregarTrofeos("SumaResta", "Pro") { nuevoTrofeo ->
            if (nuevoTrofeo != null) {
    ...
    private fun updateScoreToZero() {
        ...
        ScoreManager.levelScoresSumaRestaPro[currentLevel] = 0
        ScoreManager.saveScoreSumaRestaPro()
    }
        ...
        mainHandler.postDelayed({
            ...
            fadeOut.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                ...
                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                    ...
                    val fadeIn = AnimationUtils.loadAnimation(this@LevelResultActivitySumaRestaPro, R.anim.dialog_fade_in)
                    ...
                    val pointsAnimation = AnimationUtils.loadAnimation(this@LevelResultActivitySumaRestaPro, R.anim.points_appear_from_back)
                    ...
                    pointsAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                        ...
                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                            ...
                            val checkAnimation = AnimationUtils.loadAnimation(this@LevelResultActivitySumaRestaPro, R.anim.check_appear)
                            ...
                            checkAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                ...
                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                    ...
                                    val puntajeActualText = getString(R.string.puntaje_actual, puntosSumaRestaPro)
                                    val spannablePuntajeActual = SpannableString(puntajeActualText)
                                    val puntosStrActual = puntosSumaRestaPro.toString()
                                    ...
                                    val puntajeActualAnimation = AnimationUtils.loadAnimation(this@LevelResultActivitySumaRestaPro, R.anim.points_appear_from_back)
                                    ...
                                    puntajeActualAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                        ...
                                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                            ...
                                            val timeAnimation = AnimationUtils.loadAnimation(this@LevelResultActivitySumaRestaPro, R.anim.points_appear_from_back)
                                            ...
                                            timeAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                                ...
                                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                                    ...
                                                    val checkBlueAnimation = AnimationUtils.loadAnimation(this@LevelResultActivitySumaRestaPro, R.anim.check_appear)
                                                    ...
                                                    mainHandler.postDelayed({
                                                        ...
                                                        rankingChangedTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivitySumaRestaPro, R.anim.dialog_fade_in))
                                                    }, 300)

                                                    mainHandler.postDelayed({
                                                        unlockLevelTextView.visibility = View.VISIBLE
                                                        unlockLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivitySumaRestaPro, R.anim.dialog_fade_in))
                                                    }, 600)

                                                    mainHandler.postDelayed({
                                                        repeatLevelTextView.visibility = View.VISIBLE
                                                        repeatLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivitySumaRestaPro, R.anim.dialog_fade_in))
                                                    }, 900)
                                                }
    ...
    private fun showFailureDialog() {
        ...
        val isLevelBlockedAfterThisFail = ScoreManager.getConsecutiveFailuresSumaRestaPro(currentLevel) >= 12
