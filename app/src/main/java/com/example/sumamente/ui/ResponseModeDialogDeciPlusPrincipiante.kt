...
class ResponseModeDialogDeciPlusPrincipiante(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerDeciPlusPrincipiante? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.response_mode_dialog_deci_plus_principiante)
    ...
    fun setOnResponseModeSelectedListener(listener: OnResponseModeSelectedListenerDeciPlusPrincipiante) {
        this.listener = listener
    }

    interface OnResponseModeSelectedListenerDeciPlusPrincipiante {
