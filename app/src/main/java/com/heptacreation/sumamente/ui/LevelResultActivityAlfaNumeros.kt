...
class LevelResultActivityAlfaNumeros : BaseActivity()  {
...
// Conteo para pines //
        ...
        checkAndUpdateBestGame("AlfaNumeros", "Avanzado", currentLevel)
        ...
        ScoreManager.updateIqComponent("AlfaNumeros", "Avanzado", aporte)
        ScoreManager.saveStatsGlobalAndAlfaNumeros()
    ...
    private fun handleFailureScenario() {
        ...
        ScoreManager.updateIqComponent("AlfaNumeros", "Avanzado", 0.0)
        ScoreManager.saveStatsGlobalAndAlfaNumeros()
    }
    ...
    private fun verificarTrofeosParaDobleCondecoracion(nuevaMedalla: CondecoracionTracker.MedallaObtenida) {
        CondecoracionTracker.verificarYEntregarTrofeos("AlfaNumeros", "Avanzado") { nuevoTrofeo ->
            if (nuevoTrofeo != null) {
