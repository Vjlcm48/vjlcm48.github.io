...
class LevelsActivityGenioPlusPrincipiante : BaseActivity()  {
    ...
    enableEdgeToEdge()
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityGenioPlusPrincipiante, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
...
// Fin del código de flecha de regresar del celular
    ...
    override fun onResume() {
        super.onResume()
        ScoreManager.initGenioPlusPrincipiante(this)
        val maxCompleted = ScoreManager.getMaxLevelForCombo("GenioPlus", "Principiante")
        if (maxCompleted >= ScoreManager.unlockedLevelsGenioPlusPrincipiante) {
            ScoreManager.unlockedLevelsGenioPlusPrincipiante = maxCompleted + 1
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityGenioPlusPrincipiante)
                }
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    setMargins(0, 0, 8.dpToPx(this@LevelsActivityGenioPlusPrincipiante), 0)
                }
                ...
                setPadding(
                    16.dpToPx(this@LevelsActivityGenioPlusPrincipiante),
                    12.dpToPx(this@LevelsActivityGenioPlusPrincipiante),   // antes: 8dp
                    16.dpToPx(this@LevelsActivityGenioPlusPrincipiante),
                    12.dpToPx(this@LevelsActivityGenioPlusPrincipiante)    // antes: 8dp
                )
                ...
                if (i < ScoreManager.unlockedLevelsGenioPlusPrincipiante && !ScoreManager.isLevelBlockedByFailuresGenioPlusPrincipiante(i + 1)) {
                    ...
                    setOnClickListener {
                        if (i < ScoreManager.unlockedLevelsGenioPlusPrincipiante && ScoreManager.isLevelBlockedByFailuresGenioPlusPrincipiante(i + 1)) {
                            Toast.makeText(
                                this@LevelsActivityGenioPlusPrincipiante,
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    24.dpToPx(this@LevelsActivityGenioPlusPrincipiante),
                    24.dpToPx(this@LevelsActivityGenioPlusPrincipiante)
                ).apply { gravity = Gravity.CENTER_VERTICAL }

                setImageResource(
                    if (i < ScoreManager.unlockedLevelsGenioPlusPrincipiante)
            ...
            Log.d("LevelsActivityGenioPlusPrincipiante", "Added button for level ${i + 1}")
        }
    }
    ...
    private fun showInstructions(level: Int, mode: ResponseModeGenioPlusPrincipiante? = null) {
    ...
    private fun showResponseModeDialog(level: Int) {
        val dialog = ResponseModeDialogGenioPlusPrincipiante(this)
        dialog.setOnResponseModeSelectedListener(object : ResponseModeDialogGenioPlusPrincipiante.OnResponseModeSelectedListenerGenioPlusPrincipiante {
            override fun onResponseModeSelected(mode: ResponseModeGenioPlusPrincipiante) {
