...
class GameActivityPrincipiante : BaseActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val responseMode = prefs.getString(
            "selectedResponseModePrincipiante",
        ...
        scoreTextView.text = getString(R.string.score_label, ScoreManager.currentScorePrincipiante)
    ...
    private fun startChronometer() {
        ...
        chronometerTimer = object : CountDownTimer(10000, 75) {
            override fun onTick(millisUntilFinished: Long) {
                ...
                val textColor = when {
                    elapsedSeconds < 5.0 -> ContextCompat.getColor(this@GameActivityPrincipiante, R.color.green_medium)
                    elapsedSeconds < 8.0 -> ContextCompat.getColor(this@GameActivityPrincipiante, R.color.orange_dark)
                    else -> ContextCompat.getColor(this@GameActivityPrincipiante, R.color.red)
                }
            ...
            override fun onFinish() {
                ...
                spannableString.setSpan(
                    ForegroundColorSpan(ContextCompat.getColor(this@GameActivityPrincipiante, R.color.red)),
                    0,
                    finalTime.length,
                    Spannable.SPAN_EXCLUSIVE_EXCLUSIVE
                )
    ...
    private fun navigateToLevelResult(isSuccessful: Boolean) {
        val intent = Intent(this, LevelResultActivityPrincipiante::class.java)
