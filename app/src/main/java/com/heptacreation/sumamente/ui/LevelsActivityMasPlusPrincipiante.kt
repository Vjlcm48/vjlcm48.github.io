...
class LevelsActivityMasPlusPrincipiante : BaseActivity()  {
    ...
    enableEdgeToEdge()
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityMasPlusPrincipiante, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
    ...
    override fun onResume() {
        ...
        val maxCompleted = ScoreManager.getMaxLevelForCombo("MasPlus", "Principiante")
        if (maxCompleted >= ScoreManager.unlockedLevelsMasPlusPrincipiante) {
            ScoreManager.unlockedLevelsMasPlusPrincipiante = maxCompleted + 1
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityMasPlusPrincipiante)
                }
            ...
            val button = Button(this).apply {
                ...
                if (i < ScoreManager.unlockedLevelsMasPlusPrincipiante && !ScoreManager.isLevelBlockedByFailuresMasPlusPrincipiante(i + 1)) {
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityMasPlusPrincipiante, R.color.level_text_unlocked))
                    ...
                    setOnClickListener {
                        applyBounceEffect(this) {
                            ...
                            val storedMode = if (storedModeName != null) ResponseModeMasPlusPrincipiante.valueOf(storedModeName) else null
                    ...
                    setOnClickListener {
                        if (i < ScoreManager.unlockedLevelsMasPlusPrincipiante && ScoreManager.isLevelBlockedByFailuresMasPlusPrincipiante(i + 1)) {
                            Toast.makeText(
                                this@LevelsActivityMasPlusPrincipiante,
            ...
            Log.d("LevelsActivityMasPlusPrincipiante", "Added button for level ${i + 1}")
        }
    }
    ...
    private fun showInstructions(level: Int, mode: ResponseModeMasPlusPrincipiante? = null) {
        val intent = Intent(this, InstructionsActivityMasPlusPrincipiante::class.java)
    ...
    private fun showResponseModeDialog(level: Int) {
        val dialog = ResponseModeDialogMasPlusPrincipiante(this)
        dialog.setOnResponseModeSelectedListener(object : ResponseModeDialogMasPlusPrincipiante.OnResponseModeSelectedListenerMasPlusPrincipiante {
            override fun onResponseModeSelected(mode: ResponseModeMasPlusPrincipiante) {
