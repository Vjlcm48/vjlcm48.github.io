...
class GameActivityRomasPro : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val responseMode = intent.getStringExtra("RESPONSE_MODE_ROMAS")
            ?: prefs.getString("selectedResponseModeRomasPro", null)
    ...
    private fun navigateToLevelResult(isSuccessful: Boolean) {
        ...
        if (isSuccessful) {
            ...
            if (ScoreManager.isLevelBlockedByFailuresRomasPro(currentLevel + 1)) {
                ScoreManager.resetConsecutiveFailuresRomasPro(currentLevel + 1)
            }
        }
