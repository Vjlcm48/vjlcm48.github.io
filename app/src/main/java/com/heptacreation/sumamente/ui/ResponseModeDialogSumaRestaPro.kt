...
enum class ResponseModeSumaRestaPro {
    SIMPLE_SELECTION,
    TYPE_ANSWER
}
...
class ResponseModeDialogSumaRestaPro(context: Context) : AppCompatDialog(context) {
    ...
    private fun setupButtons() {
        ...
        btnSeleccionSimple?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeSumaRestaPro.SIMPLE_SELECTION)
            }, 1000)
        }
        ...
        btnEscribeRespuesta?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeSumaRestaPro.TYPE_ANSWER)
            }, 1000)
        }
    ...
    private fun sendResponseModeToCaller(mode: ResponseModeSumaRestaPro) {
    ...
    interface OnResponseModeSelectedListenerSumaRestaPro {
        fun onResponseModeSelected(mode: ResponseModeSumaRestaPro)
    }
}
