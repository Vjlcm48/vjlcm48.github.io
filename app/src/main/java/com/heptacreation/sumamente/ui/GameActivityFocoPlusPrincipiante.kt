...
class GameActivityFocoPlusPrincipiante : BaseActivity() {
    ...
    private fun buildLevelMetas(subtype: Int) {
        ...
        btnNoneFigures?.text = getString(R.string.answer_none)
    ...
    private fun applyFeedback() {
        ...
        val overlay = View(this).apply {
            setBackgroundColor(ContextCompat.getColor(this@GameActivityFocoPlusPrincipiante, color))
            alpha = 0f
        }
