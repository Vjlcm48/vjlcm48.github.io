...
class LevelsActivityPrincipiante : BaseActivity()  {
    ...
    enableEdgeToEdge()
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityPrincipiante, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
    ...
    override fun onResume() {
        super.onResume()
        ScoreManager.initPrincipiante(this)
        val maxCompleted = ScoreManager.getMaxLevelForCombo("NumerosPlus", "Principiante")
        if (maxCompleted >= ScoreManager.unlockedLevelsPrincipiante) {
            ScoreManager.unlockedLevelsPrincipiante = maxCompleted + 1
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityPrincipiante)
                }
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    setMargins(0, 0, 8.dpToPx(this@LevelsActivityPrincipiante), 0)
                }
                ...
                setPadding(
                    ...
                    12.dpToPx(this@LevelsActivityPrincipiante),
                    16.dpToPx(this@LevelsActivityPrincipiante),
                    12.dpToPx(this@LevelsActivityPrincipiante)
                )
                ...
                if (i < ScoreManager.unlockedLevelsPrincipiante && !ScoreManager.isLevelBlockedByFailuresPrincipiante(i + 1)) {
                    ...
                    setOnClickListener {
                        applyBounceEffect(this) {
                            ...
                            val storedModeName = prefs.getString("selectedResponseModePrincipiante", null)
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    24.dpToPx(this@LevelsActivityPrincipiante),
                    24.dpToPx(this@LevelsActivityPrincipiante)
                ).apply {
                    gravity = Gravity.CENTER_VERTICAL
                }
                setImageResource(
                    if (i < ScoreManager.unlockedLevelsPrincipiante &&
                        !ScoreManager.isLevelBlockedByFailuresPrincipiante(i + 1)
            ...
            Log.d("LevelsActivityPrincipiante", "Added button for level ${i + 1}")
        }
    }
