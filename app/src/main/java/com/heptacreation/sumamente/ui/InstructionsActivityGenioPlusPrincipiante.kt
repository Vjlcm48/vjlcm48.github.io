            ...
            dialog.setOnResponseModeSelectedListener(object : ResponseModeDialogGenioPlusPrincipiante.OnResponseModeSelectedListenerGenioPlusPrincipiante {
                override fun onResponseModeSelected(mode: ResponseModeGenioPlusPrincipiante) {
                    ...
                    getSharedPreferences("MyPrefsGenioPlus", MODE_PRIVATE)
                        .edit {
                            putString("selectedResponseModeGenioPlusPrincipiante", mode.name)
                        }
                }
            })
            dialog.show()
        ...
        btnStart.setOnClickListener {
            ...
            clickAnimatorSet.addListener(object : Animator.AnimatorListener {
                ...
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    AdManager.showInterstitialOnLevelStart(this@InstructionsActivityGenioPlusPrincipiante, level) {
                        startActivity(intent)
                    }
                }
