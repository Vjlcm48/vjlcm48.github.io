...
class LevelResultActivityDeciPlus : BaseActivity()  {
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.totalGamesDeciPlusAvanzado += 1
        ...
        ScoreManager.levelScoresDeciPlus[currentLevel]?.let { previousScore ->
            ScoreManager.currentScoreDeciPlus -= previousScore
        }

        ScoreManager.levelScoresDeciPlus[currentLevel] = pointsEarned
        ScoreManager.currentScoreDeciPlus = max(ScoreManager.currentScoreDeciPlus + pointsEarned, 0)

        if (!ScoreManager.hasCompletedLevelDeciPlus(currentLevel)) {
        ...
        checkAndUpdateBestGame("DeciPlus", "Avanzado", currentLevel)
        ...
        ScoreManager.updateIqComponent("DeciPlus", "Avanzado", aporte)
        ScoreManager.saveStatsGlobalAndDeciPlus()
    ...
    private fun handleFailureScenario() {
        ...
        ScoreManager.updateIqComponent("DeciPlus", "Avanzado", 0.0)
        ScoreManager.saveStatsGlobalAndDeciPlus()
    ...
    private fun updateScoreToZero() {
        ...
        ScoreManager.levelScoresDeciPlus[currentLevel] = 0
        ScoreManager.saveScoreDeciPlus()
    }
        ...
        mainHandler.postDelayed({
            ...
            fadeOut.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                ...
                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                    ...
                    val fadeIn = AnimationUtils.loadAnimation(this@LevelResultActivityDeciPlus, R.anim.dialog_fade_in)
                    ...
                    val pointsAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityDeciPlus, R.anim.points_appear_from_back)
                    ...
                    pointsAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                        ...
                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                            ...
                            val checkAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityDeciPlus, R.anim.check_appear)
                            ...
                            checkAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                ...
                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                    ...
                                    val puntajeActualText = getString(R.string.puntaje_actual, puntosDeciPlus)
                                    val spannablePuntajeActual = SpannableString(puntajeActualText)
                                    val puntosStrActual = puntosDeciPlus.toString()
                                    ...
                                    val puntajeActualAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityDeciPlus, R.anim.points_appear_from_back)
                                    ...
                                    puntajeActualAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                        ...
                                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                            ...
                                            val timeAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityDeciPlus, R.anim.points_appear_from_back)
                                            ...
                                            timeAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                                ...
                                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                                    ...
                                                    val checkBlueAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityDeciPlus, R.anim.check_appear)
                                                    ...
                                                    mainHandler.postDelayed({
                                                        ...
                                                        rankingChangedTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityDeciPlus, R.anim.dialog_fade_in))
                                                    }, 300)

                                                    mainHandler.postDelayed({
                                                        unlockLevelTextView.visibility = View.VISIBLE
                                                        unlockLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityDeciPlus, R.anim.dialog_fade_in))
                                                    }, 600)

                                                    mainHandler.postDelayed({
                                                        repeatLevelTextView.visibility = View.VISIBLE
                                                        repeatLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityDeciPlus, R.anim.dialog_fade_in))
                                                    }, 900)
                                                }
