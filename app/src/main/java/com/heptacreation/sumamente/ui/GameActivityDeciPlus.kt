...
class GameActivityDeciPlus : BaseActivity()  {
    ...
    private fun mostrarOverlayPista(saldo: Int) {
        ...
        // Avanzado = 4 monedas (cadena por defecto)
    ...
    private fun aplicarPistaSeleccion() {
        ...
        // DeciPlus usa Double: comparación con epsilon
    ...
    private fun navigateToLevelResult(isSuccessful: Boolean) {
        ...
        if (isSuccessful) {
            ...
            if (ScoreManager.isLevelBlockedByFailuresDeciPlus(currentLevel + 1)) {
                ScoreManager.resetConsecutiveFailuresDeciPlus(currentLevel + 1)
            }
        }
