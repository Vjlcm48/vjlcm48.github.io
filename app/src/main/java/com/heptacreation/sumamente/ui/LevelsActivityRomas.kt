...
class LevelsActivityRomas : BaseActivity()  {
    ...
    enableEdgeToEdge()
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityRomas, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
    ...
    override fun onResume() {
        ...
        val maxCompleted = ScoreManager.getMaxLevelForCombo("Romas", "Avanzado")
        if (maxCompleted >= ScoreManager.unlockedLevelsRomas) {
            ScoreManager.unlockedLevelsRomas = maxCompleted + 1
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityRomas)
                }
            ...
            val button = Button(this).apply {
                ...
                if (i < ScoreManager.unlockedLevelsRomas && !ScoreManager.isLevelBlockedByFailuresRomas(i + 1)) {
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityRomas, R.color.level_text_unlocked))
            ...
            Log.d("LevelsActivityRomas", "Added button for level ${i + 1}")
        }
    }
