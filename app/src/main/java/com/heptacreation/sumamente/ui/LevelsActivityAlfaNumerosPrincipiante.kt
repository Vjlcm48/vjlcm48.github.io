    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityAlfaNumerosPrincipiante, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
...
// Fin del código de flecha de regresar del celular
    ...
    private fun setupInfoBar() {
        ...
        tvScore.text = getString(R.string.score_format, ScoreManager.currentScoreAlfaNumerosPrincipiante)
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityAlfaNumerosPrincipiante)
                }
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    0,
                    48.dpToPx(this@LevelsActivityAlfaNumerosPrincipiante),
                    1f
                ).apply {
                    setMargins(0, 0, 8.dpToPx(this@LevelsActivityAlfaNumerosPrincipiante), 0)
                }
                ...
                setPadding(
                    16.dpToPx(this@LevelsActivityAlfaNumerosPrincipiante),
                    8.dpToPx(this@LevelsActivityAlfaNumerosPrincipiante),
                    16.dpToPx(this@LevelsActivityAlfaNumerosPrincipiante),
                    8.dpToPx(this@LevelsActivityAlfaNumerosPrincipiante)
                )
                ...
                if (i < ScoreManager.unlockedLevelsAlfaNumerosPrincipiante && !ScoreManager.isLevelBlockedByFailuresAlfaNumerosPrincipiante(i + 1)) {
                    ...
                    setOnClickListener {
                        applyBounceEffect(this) {
                            if (i < ScoreManager.unlockedLevelsAlfaNumerosPrincipiante && ScoreManager.isLevelBlockedByFailuresAlfaNumerosPrincipiante(i + 1)) {
                                Toast.makeText(
                                    this@LevelsActivityAlfaNumerosPrincipiante,
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    36.dpToPx(this@LevelsActivityAlfaNumerosPrincipiante),
                    36.dpToPx(this@LevelsActivityAlfaNumerosPrincipiante)
                ).apply {
                    gravity = Gravity.CENTER_VERTICAL
                }
                setImageResource(if (i < ScoreManager.unlockedLevelsAlfaNumerosPrincipiante && !ScoreManager.isLevelBlockedByFailuresAlfaNumerosPrincipiante(i + 1))
            ...
            Log.d("LevelsActivityAlfaNumerosPrincipiante", "Added button for level ${i + 1}")
        }
    }
    ...
    private fun showResponseModeDialog(level: Int) {
        val dialog = ResponseModeDialogAlfaNumerosPrincipiante(this)
        dialog.setOnResponseModeSelectedListener(object : ResponseModeDialogAlfaNumerosPrincipiante.OnResponseModeSelectedListenerAlfaNumerosPrincipiante {
