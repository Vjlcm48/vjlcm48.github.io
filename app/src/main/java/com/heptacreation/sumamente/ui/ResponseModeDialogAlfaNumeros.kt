...
class ResponseModeDialogAlfaNumeros(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerAlfaNumeros? = null
    ...
    interface OnResponseModeSelectedListenerAlfaNumeros {
