    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityGenioPlusPro, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
...
// Fin del código de flecha de regresar del celular
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityGenioPlusPro)
                }
            ...
            val button = Button(this).apply {
                ...
                if (i < ScoreManager.unlockedLevelsGenioPlusPro && !ScoreManager.isLevelBlockedByFailuresGenioPlusPro(i + 1)) {
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityGenioPlusPro, R.color.level_text_unlocked))
                    setOnClickListener {
                        applyBounceEffect(this) {
                            ...
                            val storedMode = if (storedModeName != null) ResponseModeGenioPlusPro.valueOf(storedModeName) else null
            ...
            Log.d("LevelsActivityGenioPlusPro", "Added button for level ${i + 1}")
        }
    }
    ...
    private fun showInstructions(level: Int, mode: ResponseModeGenioPlusPro? = null) {
