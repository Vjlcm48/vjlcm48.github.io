...
class GameActivityGenioPlusPro : BaseActivity() {
    ...
    companion object {
        private const val HINT_COST_COINS = 6
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val responseMode = prefs.getString(
            "selectedResponseModeGenioPlusPro",
    ...
    private fun mostrarOverlayPista(saldo: Int) {
        ...
        btnUseHint.text = getString(R.string.hint_use_btn_6)
    ...
    private fun startChronometer() {
        ...
        chronometerTimer = object : CountDownTimer(7000, 75) {
            override fun onTick(millisUntilFinished: Long) {
                ...
                val textColor = when {
                    elapsedSeconds < 3.0 -> ContextCompat.getColor(this@GameActivityGenioPlusPro, R.color.green_medium)
                    elapsedSeconds < 5.0 -> ContextCompat.getColor(this@GameActivityGenioPlusPro, R.color.orange_dark)
