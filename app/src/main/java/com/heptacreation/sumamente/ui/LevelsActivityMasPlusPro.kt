...
class LevelsActivityMasPlusPro : BaseActivity()  {
    ...
    enableEdgeToEdge()
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityMasPlusPro, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
    ...
    override fun onResume() {
        ...
        val maxCompleted = ScoreManager.getMaxLevelForCombo("MasPlus", "Pro")
        if (maxCompleted >= ScoreManager.unlockedLevelsMasPlusPro) {
            ScoreManager.unlockedLevelsMasPlusPro = maxCompleted + 1
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityMasPlusPro)
                }
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    setMargins(0, 0, 8.dpToPx(this@LevelsActivityMasPlusPro), 0)
                }
                ...
                minimumHeight = 56.dpToPx(this@LevelsActivityMasPlusPro)
                setPadding(
                    16.dpToPx(this@LevelsActivityMasPlusPro),
                    12.dpToPx(this@LevelsActivityMasPlusPro),
                    16.dpToPx(this@LevelsActivityMasPlusPro),
                    12.dpToPx(this@LevelsActivityMasPlusPro)
                )
                ...
                if (i < ScoreManager.unlockedLevelsMasPlusPro && !ScoreManager.isLevelBlockedByFailuresMasPlusPro(i + 1)) {
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityMasPlusPro, R.color.level_text_unlocked))
                    ...
                    setOnClickListener {
                        applyBounceEffect(this) {
                            ...
                            val storedMode = if (storedModeName != null) ResponseModeMasPlusPro.valueOf(storedModeName) else null
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityMasPlusPro, android.R.color.black))
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    24.dpToPx(this@LevelsActivityMasPlusPro),
                    24.dpToPx(this@LevelsActivityMasPlusPro)
                ).apply { gravity = Gravity.CENTER_VERTICAL }

                setImageResource(
                    if (i < ScoreManager.unlockedLevelsMasPlusPro &&
                        !ScoreManager.isLevelBlockedByFailuresMasPlusPro(i + 1)
            ...
            Log.d("LevelsActivityMasPlusPro", "Added button for level ${i + 1}")
        }
    }
    ...
    private fun showInstructions(level: Int, mode: ResponseModeMasPlusPro? = null) {
    ...
    private fun showResponseModeDialog(level: Int) {
        val dialog = ResponseModeDialogMasPlusPro(this)
        dialog.setOnResponseModeSelectedListener(object : ResponseModeDialogMasPlusPro.OnResponseModeSelectedListenerMasPlusPro {
            override fun onResponseModeSelected(mode: ResponseModeMasPlusPro) {
