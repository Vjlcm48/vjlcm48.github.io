    ...
    private fun createLevelButtons() {
        ...
        for (i in levelStrings.indices) {
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    0,
                    48.dpToPx(this@LevelsActivityMasPlusPro),
                    1f
                ).apply {
                ...
                setPadding(
                    ...
                    8.dpToPx(this@LevelsActivityMasPlusPro),
                    16.dpToPx(this@LevelsActivityMasPlusPro),
                    8.dpToPx(this@LevelsActivityMasPlusPro)
                )
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    36.dpToPx(this@LevelsActivityMasPlusPro),
                    36.dpToPx(this@LevelsActivityMasPlusPro)
                ).apply {
                    gravity = Gravity.CENTER_VERTICAL
                }
                setImageResource(if (i < ScoreManager.unlockedLevelsMasPlusPro && !ScoreManager.isLevelBlockedByFailuresMasPlusPro(i + 1))
