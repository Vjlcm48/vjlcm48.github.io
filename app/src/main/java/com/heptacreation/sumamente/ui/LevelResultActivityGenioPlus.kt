...
class LevelResultActivityGenioPlus : BaseActivity()  {
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.totalGamesGenioPlusAvanzado += 1
        ...
        checkAndUpdateBestGame("GenioPlus", "Avanzado", currentLevel)
        ...
        ScoreManager.updateIqComponent("GenioPlus", "Avanzado", aporte)
        ScoreManager.saveStatsGlobalAndGenioPlus()
    ...
    private fun handleFailureScenario() {
        ...
        ScoreManager.updateIqComponent("GenioPlus", "Avanzado", 0.0)
        ScoreManager.saveStatsGlobalAndGenioPlus()
    ...
    private fun verificarTrofeosParaDobleCondecoracion(nuevaMedalla: CondecoracionTracker.MedallaObtenida) {
        CondecoracionTracker.verificarYEntregarTrofeos("GenioPlus", "Avanzado") { nuevoTrofeo ->
            if (nuevoTrofeo != null) {
