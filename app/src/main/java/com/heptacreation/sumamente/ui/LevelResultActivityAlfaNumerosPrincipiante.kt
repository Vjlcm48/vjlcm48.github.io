...
class LevelResultActivityAlfaNumerosPrincipiante : BaseActivity()  {
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.totalGamesAlfaNumerosPrincipiante += 1
        ...
        checkAndUpdateBestGame("AlfaNumeros", "Principiante", currentLevel)
    ...
    private fun verificarTrofeosParaDobleCondecoracion(nuevaMedalla: CondecoracionTracker.MedallaObtenida) {
        CondecoracionTracker.verificarYEntregarTrofeos("AlfaNumeros", "Principiante") { nuevoTrofeo ->
            if (nuevoTrofeo != null) {
