...
class GameActivitySumaRestaPrincipiante : BaseActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val responseMode = prefs.getString("selectedResponseModeSumaRestaPrincipiante", intent.getStringExtra("RESPONSE_MODE"))
        ...
        scoreTextView.text = getString(R.string.score_label, ScoreManager.currentScoreSumaRestaPrincipiante)
    ...
    private fun startChronometer() {
        ...
        chronometerTimer = object : CountDownTimer(10000, 75) { // Cambio de 7000 a 10000 ms para principiante
            override fun onTick(millisUntilFinished: Long) {
                ...
                val textColor = when {
                    elapsedSeconds < 5.0 -> ContextCompat.getColor(this@GameActivitySumaRestaPrincipiante, R.color.green_medium)
                    elapsedSeconds < 8.0 -> ContextCompat.getColor(this@GameActivitySumaRestaPrincipiante, R.color.orange_dark)
                    else -> ContextCompat.getColor(this@GameActivitySumaRestaPrincipiante, R.color.red)
                }
            ...
            override fun onFinish() {
                ...
                spannableString.setSpan(
                    ForegroundColorSpan(ContextCompat.getColor(this@GameActivitySumaRestaPrincipiante, R.color.red)),
                    0,
                    finalTime.length,
                    Spannable.SPAN_EXCLUSIVE_EXCLUSIVE
                )
    ...
    private fun navigateToLevelResult(isSuccessful: Boolean) {
        val intent = Intent(this, LevelResultActivitySumaRestaPrincipiante::class.java)
