...
class ResponseModeDialogAlfaNumerosPrincipiante(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerAlfaNumerosPrincipiante? = null
    ...
    interface OnResponseModeSelectedListenerAlfaNumerosPrincipiante {
