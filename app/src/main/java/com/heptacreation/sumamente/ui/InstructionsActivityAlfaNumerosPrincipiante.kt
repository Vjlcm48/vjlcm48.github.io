            ...
            dialog.setOnResponseModeSelectedListener(object : ResponseModeDialogAlfaNumerosPrincipiante.OnResponseModeSelectedListenerAlfaNumerosPrincipiante {
                override fun onResponseModeSelected(mode: ResponseModeAlfaNumeros) {
                    ...
                    getSharedPreferences("MyPrefsAlfaNumeros", MODE_PRIVATE)
                        .edit {
                            putString("selectedResponseModeAlfaNumerosPrincipiante", mode.name)
                        }
                }
            })
            dialog.show()
            ...
            clickAnimatorSet.addListener(object : Animator.AnimatorListener {
                ...
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    if (mode != null) {
                        ...
                        prefs.edit { putString("selectedResponseModeAlfaNumerosPrincipiante", mode.name) }
                    }
                    val intent = Intent(this@InstructionsActivityAlfaNumerosPrincipiante, GameActivityAlfaNumerosPrincipiante::class.java)
                    intent.putExtra("LEVEL", level)
                    if (mode != null) {
                        intent.putExtra("RESPONSE_MODE", mode.name)
                    }
                    intent.putExtra("EXCLUDED_INDEX", excludedIndex)
                    AdManager.showInterstitialOnLevelStart(this@InstructionsActivityAlfaNumerosPrincipiante, level) {
                        startActivity(intent)
                }
                }
            ...
            clickAnimatorSet.addListener(object : Animator.AnimatorListener {
                ...
                override fun onAnimationEnd(animation: Animator) {
                    val intent = DifficultySelectionActivity.createIntent(
                        this@InstructionsActivityAlfaNumerosPrincipiante,
                        "AlfaNumeros",
                        true,
                        level,
                        responseMode?.name
