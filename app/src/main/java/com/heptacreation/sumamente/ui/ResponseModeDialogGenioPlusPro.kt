...
enum class ResponseModeGenioPlusPro {
    SIMPLE_SELECTION,
    TYPE_ANSWER
}

class ResponseModeDialogGenioPlusPro(context: Context) : AppCompatDialog(context) {

    private var listener: OnResponseModeSelectedListenerGenioPlusPro? = null
    ...
    private fun setupButtons() {
        ...
        btnSeleccionSimple?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeGenioPlusPro.SIMPLE_SELECTION)
            }, 1000)
        }
        ...
        btnEscribeRespuesta?.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                sendResponseModeToCaller(ResponseModeGenioPlusPro.TYPE_ANSWER)
            }, 1000)
        }
    ...
    private fun sendResponseModeToCaller(mode: ResponseModeGenioPlusPro) {
    ...
    fun setOnResponseModeSelectedListener(listener: OnResponseModeSelectedListenerGenioPlusPro) {
        this.listener = listener
    }

    interface OnResponseModeSelectedListenerGenioPlusPro {
        fun onResponseModeSelected(mode: ResponseModeGenioPlusPro)
    }
}
