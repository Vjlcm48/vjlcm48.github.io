...
class LevelsActivityAlfaNumeros : BaseActivity()  {
    ...
    enableEdgeToEdge()
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityAlfaNumeros, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
    ...
    override fun onResume() {
        ...
        val maxCompleted = ScoreManager.getMaxLevelForCombo("AlfaNumeros", "Avanzado")
        if (maxCompleted >= ScoreManager.unlockedLevelsAlfaNumeros) {
            ScoreManager.unlockedLevelsAlfaNumeros = maxCompleted + 1
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityAlfaNumeros)
                }
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    setMargins(0, 0, 8.dpToPx(this@LevelsActivityAlfaNumeros), 0)
                }
                ...
                minimumHeight = 56.dpToPx(this@LevelsActivityAlfaNumeros)
                setPadding(
                    16.dpToPx(this@LevelsActivityAlfaNumeros),
                    12.dpToPx(this@LevelsActivityAlfaNumeros),
                    16.dpToPx(this@LevelsActivityAlfaNumeros),
                    12.dpToPx(this@LevelsActivityAlfaNumeros)
                )
                ...
                if (i < ScoreManager.unlockedLevelsAlfaNumeros && !ScoreManager.isLevelBlockedByFailuresAlfaNumeros(i + 1)) {
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityAlfaNumeros, R.color.level_text_unlocked))
                    ...
                    setOnClickListener {
                        applyBounceEffect(this) {
                            ...
                            val storedModeName = prefs.getString("selectedResponseModeAlfaNumeros", null)
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityAlfaNumeros, android.R.color.black))
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    24.dpToPx(this@LevelsActivityAlfaNumeros),   // antes: 36.dpToPx(...)
                    24.dpToPx(this@LevelsActivityAlfaNumeros)
                ).apply { gravity = Gravity.CENTER_VERTICAL }

                setImageResource(
                    if (i < ScoreManager.unlockedLevelsAlfaNumeros &&
                        !ScoreManager.isLevelBlockedByFailuresAlfaNumeros(i + 1)
            ...
            Log.d("LevelsActivityAlfaNumeros", "Added button for level ${i + 1}")
        }
    }
    ...
    private fun showInstructions(level: Int, mode: ResponseModeAlfaNumeros? = null) {
    ...
    private fun showResponseModeDialog(level: Int) {
        val dialog = ResponseModeDialogAlfaNumeros(this)
        dialog.setOnResponseModeSelectedListener(object : ResponseModeDialogAlfaNumeros.OnResponseModeSelectedListenerAlfaNumeros {
