    ...
    private fun createLevelButtons() {
        ...
        for (i in levelStrings.indices) {
            ...
            val button = Button(this).apply {
                ...
                minimumHeight = 56.dpToPx(this@LevelsActivitySumaRestaPro)
                setPadding(
                    16.dpToPx(this@LevelsActivitySumaRestaPro),
                    12.dpToPx(this@LevelsActivitySumaRestaPro),
                    16.dpToPx(this@LevelsActivitySumaRestaPro),
                    12.dpToPx(this@LevelsActivitySumaRestaPro)
                )
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    24.dpToPx(this@LevelsActivitySumaRestaPro),
                    24.dpToPx(this@LevelsActivitySumaRestaPro)
                ).apply { gravity = Gravity.CENTER_VERTICAL }

                setImageResource(
                    if (i < ScoreManager.unlockedLevelsSumaRestaPro &&
                        (!ScoreManager.isLevelBlockedByFailuresSumaRestaPro(i + 1) || i == 0)
