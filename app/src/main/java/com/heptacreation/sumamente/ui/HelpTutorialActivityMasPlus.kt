...
class HelpTutorialActivityMasPlus : BaseActivity()  {
    ...
    private fun initViews() {
        ...
        checkEscribeRespuesta = findViewById(R.id.check_escribe_respuesta_hm)
    ...
    private fun hideModesDialogMasPlus() {
        val fadeOut = AnimationUtils.loadAnimation(this, R.anim.activity_fade_out)
    ...
    private fun displayNextNumber() {
        ...
        tvNumber.apply {
            ...
            when {
                ...
                number == "0.4" && currentNumberIndex == 6 -> {
            ...
            val bounce = AnimationUtils.loadAnimation(this@HelpTutorialActivityMasPlus, R.anim.bounce_in)
    ...
    private fun showChronometerAndInput() {
                    ...
                    when {
                        seconds < 3.0 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@HelpTutorialActivityMasPlus, R.color.green_medium)
                            )
                        }
                        seconds < 4.36 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@HelpTutorialActivityMasPlus, R.color.orange_dark)
                            )
                        }
                        else -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@HelpTutorialActivityMasPlus, R.color.red)
                            )
                        }
                    }
        ...
        handler.postDelayed({
            applyBounceEffect(etUserAnswer){
                simulateKeyboardPress("3", etUserAnswer)
            }
        }, 1500)
    ...
    private fun repeatTutorial() {
        stopBackgroundMusic()
        val intent = Intent(this, HelpTutorialActivityMasPlus::class.java)
        startActivity(intent)
        finish()
    }
    ...
    private fun startBackgroundMusic() {
        ...
        if (sharedPreferences.getBoolean(SettingsActivity.SOUND_ENABLED, true)) {
            backgroundMusicPlayer = MediaPlayer.create(this, R.raw.tutorial5)
