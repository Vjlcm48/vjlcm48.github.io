            ...
            dialog.setOnResponseModeSelectedListener(object : ResponseModeDialogRomasPro.OnResponseModeSelectedListenerRomasPro {
                override fun onResponseModeSelected(mode: ResponseModeRomasPro) {
                    responseMode = when(mode) {
                        ResponseModeRomasPro.SIMPLE_SELECTION_ROMAS -> ResponseModeRomas.SIMPLE_SELECTION_ROMAS
                        ResponseModeRomasPro.TYPE_ANSWER_ROMAS -> ResponseModeRomas.TYPE_ANSWER_ROMAS
                    }
                    getSharedPreferences("MyPrefsRomas", MODE_PRIVATE)
                        .edit {
                            putString("selectedResponseModeRomasPro", mode.name)
                        }
                }
            })
            dialog.show()
        ...
        btnStart.setOnClickListener {
            ...
            clickAnimatorSet.addListener(object : Animator.AnimatorListener {
                ...
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    AdManager.showInterstitialOnLevelStart(this@InstructionsActivityRomasPro, level) {
                        startActivity(intent)
                    }
                }
