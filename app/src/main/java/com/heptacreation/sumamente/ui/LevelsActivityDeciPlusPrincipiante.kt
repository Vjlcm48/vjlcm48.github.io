...
class LevelsActivityDeciPlusPrincipiante : BaseActivity()  {
    ...
    enableEdgeToEdge()
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityDeciPlusPrincipiante, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
    ...
    override fun onResume() {
        ...
        val maxCompleted = ScoreManager.getMaxLevelForCombo("DeciPlus", "Principiante")
        if (maxCompleted >= ScoreManager.unlockedLevelsDeciPlusPrincipiante) {
            ScoreManager.unlockedLevelsDeciPlusPrincipiante = maxCompleted + 1
        ...
        for (i in levelStrings.indices) {
            ...
            val button = Button(this).apply {
                ...
                if (i < ScoreManager.unlockedLevelsDeciPlusPrincipiante && !ScoreManager.isLevelBlockedByFailuresDeciPlusPrincipiante(i + 1)) {
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityDeciPlusPrincipiante, R.color.level_text_unlocked))
                    setOnClickListener {
