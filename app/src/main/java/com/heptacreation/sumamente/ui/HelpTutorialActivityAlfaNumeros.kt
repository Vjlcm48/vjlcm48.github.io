...
class HelpTutorialActivityAlfaNumeros : BaseActivity()  {
    ...
    private fun initViews() {
        ...
        tvGameName.text = getString(R.string.game_alfa_numeros)
        ...
        checkEscribeRespuesta = findViewById(R.id.check_escribe_respuesta_han)
    ...
    private fun hideModesDialogAlfaNumeros() {
        val fadeOut = AnimationUtils.loadAnimation(this, R.anim.activity_fade_out)
    ...
    private fun displayNextNumber() {
        ...
        tvNumber.apply {
            ...
            val bounce = AnimationUtils.loadAnimation(this@HelpTutorialActivityAlfaNumeros, R.anim.bounce_in)
    ...
    private fun showChronometerAndInput() {
                    ...
                    when {
                        seconds < 3.0 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@HelpTutorialActivityAlfaNumeros, R.color.green_medium)
                            )
                        }
                        seconds < 4.36 -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@HelpTutorialActivityAlfaNumeros, R.color.orange_dark)
                            )
                        }
                        else -> {
                            chronometerTextView.setTextColor(
                                ContextCompat.getColor(this@HelpTutorialActivityAlfaNumeros, R.color.red)
                            )
                        }
                    }
        ...
        handler.postDelayed({
            applyBounceEffect(etUserAnswer) {
                simulateKeyboardPress("4", etUserAnswer)
            }
        }, 2000)
    ...
    private fun repeatTutorial() {
        stopBackgroundMusic()
        val intent = Intent(this, HelpTutorialActivityAlfaNumeros::class.java)
        startActivity(intent)
        finish()
    }
