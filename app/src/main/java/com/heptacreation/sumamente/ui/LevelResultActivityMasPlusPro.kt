...
class LevelResultActivityMasPlusPro : BaseActivity()  {
...
// Conteo para pines //
        ...
        checkAndUpdateBestGame("MasPlus", "Pro", currentLevel)
    ...
    private fun verificarTrofeosParaDobleCondecoracion(nuevaMedalla: CondecoracionTracker.MedallaObtenida) {
        CondecoracionTracker.verificarYEntregarTrofeos("MasPlus", "Pro") { nuevoTrofeo ->
            if (nuevoTrofeo != null) {
    ...
    private fun calculatePoints(): Int {
        ...
        val tiempoPromedio = if (ScoreManager.totalGamesMasPlus > 0) {
