...
class LevelsActivitySumaResta : BaseActivity()  {
    ...
    enableEdgeToEdge()
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivitySumaResta, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
    ...
    override fun onResume() {
        ...
        val maxCompleted = ScoreManager.getMaxLevelForCombo("SumaResta", "Avanzado")
        if (maxCompleted >= ScoreManager.unlockedLevelsSumaResta) {
            ScoreManager.unlockedLevelsSumaResta = maxCompleted + 1
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivitySumaResta)
                }
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    setMargins(0, 0, 8.dpToPx(this@LevelsActivitySumaResta), 0)
                }
                ...
                //setTextColor(ContextCompat.getColor(this@LevelsActivitySumaResta, android.R.color.white))
                gravity = Gravity.CENTER

                minimumHeight = 56.dpToPx(this@LevelsActivitySumaResta)
                setPadding(
                    16.dpToPx(this@LevelsActivitySumaResta),
                    12.dpToPx(this@LevelsActivitySumaResta),
                    16.dpToPx(this@LevelsActivitySumaResta),
                    12.dpToPx(this@LevelsActivitySumaResta)
                )
                ...
                if (i < ScoreManager.unlockedLevelsSumaResta && (!ScoreManager.isLevelBlockedByFailuresSumaResta(i + 1) || i == 0)) {
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivitySumaResta, R.color.level_text_unlocked))
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivitySumaResta, android.R.color.black))
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    24.dpToPx(this@LevelsActivitySumaResta),
                    24.dpToPx(this@LevelsActivitySumaResta)
                ).apply { gravity = Gravity.CENTER_VERTICAL }

                setImageResource(
                    if (i < ScoreManager.unlockedLevelsSumaResta &&
                        (!ScoreManager.isLevelBlockedByFailuresSumaResta(i + 1) || i == 0)
            ...
            Log.d("LevelsActivitySumaResta", "Added button for level ${i + 1}")
        }
    }
    ...
    private fun showInstructions(level: Int, mode: ResponseModeSumaResta? = null) {
        val intent = Intent(this, InstructionsActivitySumaResta::class.java)
