...
class LevelsActivityGenioPlus : BaseActivity()  {
    ...
    enableEdgeToEdge()
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                val intent = Intent(this@LevelsActivityGenioPlus, GameSelectionActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_NEW_TASK)
                startActivity(intent)
                finish()
            }
...
// Fin del código de flecha de regresar del celular
    ...
    override fun onResume() {
        ...
        val maxCompleted = ScoreManager.getMaxLevelForCombo("GenioPlus", "Avanzado")
        if (maxCompleted >= ScoreManager.unlockedLevelsGenioPlus) {
            ScoreManager.unlockedLevelsGenioPlus = maxCompleted + 1
        ...
        for (i in levelStrings.indices) {
            val levelLayout = LinearLayout(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    bottomMargin = 8.dpToPx(this@LevelsActivityGenioPlus)
                }
            ...
            val button = Button(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    ...
                    setMargins(0, 0, 8.dpToPx(this@LevelsActivityGenioPlus), 0)
                }
                ...
                minimumHeight = 56.dpToPx(this@LevelsActivityGenioPlus)
                setPadding(
                    16.dpToPx(this@LevelsActivityGenioPlus),
                    12.dpToPx(this@LevelsActivityGenioPlus),
                    16.dpToPx(this@LevelsActivityGenioPlus),
                    12.dpToPx(this@LevelsActivityGenioPlus)
                )
                ...
                if (i < ScoreManager.unlockedLevelsGenioPlus && !ScoreManager.isLevelBlockedByFailuresGenioPlus(i + 1)) {
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityGenioPlus, R.color.level_text_unlocked))
                    ...
                    setOnClickListener {
                        applyBounceEffect(this) {
                            ...
                            val storedMode = if (storedModeName != null) ResponseModeGenioPlus.valueOf(storedModeName) else null
                    ...
                    setTextColor(ContextCompat.getColor(this@LevelsActivityGenioPlus, android.R.color.black))
            ...
            val lockIcon = ImageView(this).apply {
                layoutParams = LinearLayout.LayoutParams(
                    24.dpToPx(this@LevelsActivityGenioPlus),
                    24.dpToPx(this@LevelsActivityGenioPlus)
                ).apply { gravity = Gravity.CENTER_VERTICAL }

                setImageResource(
                    if (i < ScoreManager.unlockedLevelsGenioPlus) R.drawable.ic_unlock else R.drawable.ic_lock
                )
            ...
            Log.d("LevelsActivityGenios", "Added button for level ${i + 1}")
        }
    }
    ...
    private fun showInstructions(level: Int, mode: ResponseModeGenioPlus? = null) {
