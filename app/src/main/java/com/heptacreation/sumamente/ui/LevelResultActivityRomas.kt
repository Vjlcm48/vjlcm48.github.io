...
class LevelResultActivityRomas : BaseActivity()  {
    ...
    private fun handleSuccessScenario() {
        ...
        ScoreManager.levelScoresRomas[currentLevel] = pointsEarned
        ScoreManager.currentScoreRomas = max(ScoreManager.currentScoreRomas + pointsEarned, 0)

        if (!ScoreManager.hasCompletedLevelRomas(currentLevel)) {
            ScoreManager.addCompletedLevelRomas(currentLevel)
        }
        ...
        checkAndUpdateBestGame("Romas", "Avanzado", currentLevel)
        ...
        val aporte = ((factor * velocidad * precision * 9) * 100).roundToInt() / 100.0
        ScoreManager.updateIqComponent("Romas", "Avanzado", aporte)
        ScoreManager.saveStatsGlobalAndRomas()
    ...
    private fun handleFailureScenario() {
        ...
        ScoreManager.updateIqComponent("Romas", "Avanzado", 0.0)
        ScoreManager.saveStatsGlobalAndRomas()
    ...
    private fun verificarTrofeosParaDobleCondecoracion(nuevaMedalla: CondecoracionTracker.MedallaObtenida) {
        CondecoracionTracker.verificarYEntregarTrofeos("Romas", "Avanzado") { nuevoTrofeo ->
            if (nuevoTrofeo != null) {
    ...
    private fun updateScoreToZero() {
        ...
        ScoreManager.levelScoresRomas[currentLevel] = 0
        ScoreManager.saveScoreRomas()
    }
        ...
        mainHandler.postDelayed({
            ...
            fadeOut.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                ...
                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                    ...
                    val fadeIn = AnimationUtils.loadAnimation(this@LevelResultActivityRomas, R.anim.dialog_fade_in)
                    ...
                    val pointsAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityRomas, R.anim.points_appear_from_back)
                    ...
                    pointsAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                        ...
                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                            ...
                            val checkAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityRomas, R.anim.check_appear)
                            ...
                            checkAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                ...
                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                    ...
                                    val puntajeActualText = getString(R.string.puntaje_actual, puntosRomas)
                                    val spannablePuntajeActual = SpannableString(puntajeActualText)
                                    val puntosStrActual = puntosRomas.toString()
                                    ...
                                    val puntajeActualAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityRomas, R.anim.points_appear_from_back)
                                    ...
                                    puntajeActualAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                        ...
                                        override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                            ...
                                            val timeAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityRomas, R.anim.points_appear_from_back)
                                            ...
                                            timeAnimation.setAnimationListener(object : android.view.animation.Animation.AnimationListener {
                                                ...
                                                override fun onAnimationEnd(animation: android.view.animation.Animation?) {
                                                    ...
                                                    val checkBlueAnimation = AnimationUtils.loadAnimation(this@LevelResultActivityRomas, R.anim.check_appear)
                                                    ...
                                                    mainHandler.postDelayed({
                                                        ...
                                                        rankingChangedTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityRomas, R.anim.dialog_fade_in))
                                                    }, 300)

                                                    mainHandler.postDelayed({
                                                        unlockLevelTextView.visibility = View.VISIBLE
                                                        unlockLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityRomas, R.anim.dialog_fade_in))
                                                    }, 600)

                                                    mainHandler.postDelayed({
                                                        repeatLevelTextView.visibility = View.VISIBLE
                                                        repeatLevelTextView.startAnimation(AnimationUtils.loadAnimation(this@LevelResultActivityRomas, R.anim.dialog_fade_in))
                                                    }, 900)
                                                }
    ...
    private fun navigateToInstructions() {
        val intent = Intent(this, InstructionsActivityRomas::class.java)
        intent.putExtra("LEVEL", currentLevel)
        startActivity(intent)
        finish()
    }
